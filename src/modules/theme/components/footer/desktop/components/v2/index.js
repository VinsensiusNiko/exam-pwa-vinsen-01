...
const FooterV2 = (props) => {
    ...
    return (
        <>
            <div className="bg-neutral-100 flex flex-col justify-center items-center footer-custom">
                ...
                <style jsx global>
                    {`
                        ...
                        .footer-custom {
                            background-color: ${COLORS.secondary.black2};
                        }
                        .footer-custom .footer-links.payment-list {
                            background-color: ${COLORS.secondary.black1};
                        }
                        .footer-custom .prose a {
                            color: ${COLORS.secondary.gray};
                            font-weight: 500;
                        }
                        .footer-custom .magezon-icon i.fab {
