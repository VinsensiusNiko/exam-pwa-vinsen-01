                ...
                >
                    <Button
                        ...
                        className={cx(
                            ...
                            'group/left-nav',
                            '!rounded-full',
                            'bg-primary-blackOpacity',
                            leftNavClassName,
                        )}
                        classNameText="!text-neutral-white group-hover/left-nav:!text-primary"
                    ...
                    <Button
                        ...
                        classNameText="!text-neutral-white group-hover/right-nav:!text-primary"
